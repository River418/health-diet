import { __commonJS, __esm, __export, __toCommonJS } from "./chunk-UG6XUGBP.js";
        ...
        if (child.type === 1 && child.tagType === 0) {
            ...
            if (constantType >= 2) {
                if (child.codegenNode.type === 14 && child.codegenNode.arguments.length > 0) {
                    child.codegenNode.arguments.push(-1 + (true ? ` /* ${PatchFlagNames[-1]} */` : ``));
                }
                toCache.push(child);
                continue;
            }
...
function buildSlots(node, context, buildSlotFn = buildClientSlotFn) {
    ...
    createSimpleExpression(slotFlag + (true ? ` /* ${slotFlagsText[slotFlag]} */` : ``), false))), loc);
...
export { require_vue }; /*! Bundled license information:
