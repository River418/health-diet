...
import { Current, addLeadingSlash, eventHandler, getPageInstance, incrementId, init_runtime_esm, injectPageInstance, removePageInstance, safeExecute } from "./chunk-SUQ3BRSI.js";
import { ensure, hooks, init_shared_esm, isArray, isFunction, isUndefined } from "./chunk-FGSKXN6S.js";
    ...
    if (false) {
        hooks.tap("createPullDownComponent", (component, path, h, _, stampId)=>{
            const inject2 = {
                ...
                created () {
                    const pagePath = stampId ? getPath(path, {
                        stamp: stampId
                    }) : path;
...
function createVue3Page(h, id) {
    return function(component) {
        ...
        const RootElement = false ? "div" : "root";
