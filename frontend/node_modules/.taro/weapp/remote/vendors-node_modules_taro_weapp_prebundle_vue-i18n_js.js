"use strict";
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["vendors-node_modules_taro_weapp_prebundle_vue-i18n_js"],{

/***/ "./node_modules/.taro/weapp/prebundle/chunk-L6GOBQTK.js":
/*!**************************************************************!*\
  !*** ./node_modules/.taro/weapp/prebundle/chunk-L6GOBQTK.js ***!
  \**************************************************************/
...
/* harmony export */ });
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-SUQ3BRSI.js */ "./node_modules/.taro/weapp/prebundle/chunk-SUQ3BRSI.js")["nav"];
/* provided dependency */ var window = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-SUQ3BRSI.js */ "./node_modules/.taro/weapp/prebundle/chunk-SUQ3BRSI.js")["window$1"];
...
/***/ "./node_modules/.taro/weapp/prebundle/vue-i18n.js":
/*!********************************************************!*\
  !*** ./node_modules/.taro/weapp/prebundle/vue-i18n.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   VERSION: function() { return /* binding */ VERSION2; },
...
/* harmony export */ });
/* harmony import */ var _chunk_L6GOBQTK_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-L6GOBQTK.js */ "./node_modules/.taro/weapp/prebundle/chunk-L6GOBQTK.js");
/* harmony import */ var _chunk_EJEZYNDH_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-EJEZYNDH.js */ "./node_modules/.taro/weapp/prebundle/chunk-EJEZYNDH.js");
...
var isNumber = (val1)=>typeof val1 === "number" && isFinite(val1);
var isDate = (val1)=>toTypeString(val1) === "[object Date]";
var isRegExp = (val1)=>toTypeString(val1) === "[object RegExp]";
var isEmptyObject = (val1)=>isPlainObject(val1) && Object.keys(val1).length === 0;
var assign = Object.assign;
var _create = Object.create;
var create = (obj = null)=>_create(obj);
var _globalThis;
var getGlobalThis = ()=>{
    return _globalThis || (_globalThis = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : typeof __webpack_require__.g !== "undefined" ? __webpack_require__.g : create());
};
...
var isFunction = (val1)=>typeof val1 === "function";
var isString = (val1)=>typeof val1 === "string";
var isBoolean = (val1)=>typeof val1 === "boolean";
var isObject = (val1)=>val1 !== null && typeof val1 === "object";
var isPromise = (val1)=>{
    return isObject(val1) && isFunction(val1.then) && isFunction(val1.catch);
};
var objectToString = Object.prototype.toString;
var toTypeString = (value)=>objectToString.call(value);
var isPlainObject = (val1)=>{
    if (!isObject(val1)) return false;
    const proto = Object.getPrototypeOf(val1);
    return proto === null || proto.constructor === Object;
};
var toDisplayString = (val1)=>{
    return val1 == null ? "" : isArray(val1) || isPlainObject(val1) && val1.toString === objectToString ? JSON.stringify(val1, null, 2) : String(val1);
};
...
function createEmitter() {
    ...
    const emitter = {
        ...
        on (event, handler1) {
            ...
            const added = handlers && handlers.push(handler1);
            if (!added) {
                events.set(event, [
                    handler1
                ]);
        ...
        off (event, handler1) {
            const handlers = events.get(event);
            if (handlers) {
                handlers.splice(handlers.indexOf(handler1) >>> 0, 1);
            }
        },
        emit (event, payload) {
            (events.get(event) || []).slice().map((handler1)=>handler1(payload));
            (events.get("*") || []).slice().map((handler1)=>handler1(event, payload));
        }
    };
    return emitter;
}
var isNotObjectOrIsArray = (val1)=>!isObject(val1) || isArray(val1);
...
var isString2 = (val1)=>typeof val1 === "string";
var isObject2 = (val1)=>val1 !== null && typeof val1 === "object";
...
function isMessageAST(val1) {
    return isObject(val1) && resolveType(val1) === 0 && (hasOwn(val1, "b") || hasOwn(val1, "body"));
}
var PROPS_BODY = [
    "b",
    "body"
...
function createMessageContext(options = {}) {
    ...
    const linked = (key, ...args)=>{
        ...
        const msg = // The message in vnode resolved with linked are returned as an array by processor.nomalize
...
function createCoreError(code3) {
    return createCompileError(code3, null,  true ? {
        messages: errorMessages2
    } : 0);
}
var errorMessages2 = {
...
function fallbackWithSimple(ctx, fallback, start) {
    return [
        .../* @__PURE__ */ new Set([
            start,
            ...isArray(fallback) ? fallback : isObject(fallback) ? Object.keys(fallback) : isString(fallback) ? [
                fallback
            ] : [
                start
            ]
...
function getDefaultLinkedModifiers() {
    return {
        upper: (val1, type)=>{
            return type === "text" && isString(val1) ? val1.toUpperCase() : type === "vnode" && isObject(val1) && "__v_isVNode" in val1 ? val1.children.toUpperCase() : val1;
        },
        lower: (val1, type)=>{
            return type === "text" && isString(val1) ? val1.toLowerCase() : type === "vnode" && isObject(val1) && "__v_isVNode" in val1 ? val1.children.toLowerCase() : val1;
        },
        capitalize: (val1, type)=>{
            return type === "text" && isString(val1) ? capitalize(val1) : type === "vnode" && isObject(val1) && "__v_isVNode" in val1 ? capitalize(val1.children) : val1;
        }
    };
}
var _compiler;
...
function formatMessageParts(ctx, node) {
    ...
    if (static_ != null) {
        return ctx.type === "text" ? static_ : ctx.normalize([
            static_
        ]);
    } else {
        const messages = resolveItems(node).reduce((acm, c)=>[
                ...acm,
                formatMessagePart(ctx, c)
            ], []);
...
function baseCompile2(message, options = {}) {
    ...
    return _object_spread_props(_object_spread({}, baseCompile(message, options)), {
        detectError
    });
}
...
function compile(message, context) {
    ...
    if (__INTLIFY_JIT_COMPILATION__ && !__INTLIFY_DROP_MESSAGE_COMPILER__ && isString(message)) {
        ...
        const { ast, detectError } = baseCompile2(message, _object_spread_props(_object_spread({}, context), {
            location: true,
            jit: true
        }));
...
var isMessageFunction = (val1)=>isFunction(val1);
...
function getMessageContextOptions(context, locale, message, options) {
    ...
    const resolveMessage = (key)=>{
        let val1 = resolveValue2(message, key);
        if (val1 == null && fallbackContext) {
            const [, , message2] = resolveMessageFormat(fallbackContext, key, locale, fallbackLocale, fallbackWarn, missingWarn);
            val1 = resolveValue2(message2, key);
        }
        if (isString(val1) || isMessageAST(val1)) {
            let occurred = false;
            const onError = ()=>{
                occurred = true;
            };
            const msg = compileMessageFormat(context, key, locale, val1, key, onError);
            return !occurred ? msg : NOOP_MESSAGE_FUNCTION;
        } else if (isMessageFunction(val1)) {
            return val1;
        } else {
...
function datetime(context, ...args) {
    ...
    for(let i = 0; i < locales.length; i++){
        ...
        if (isPlainObject(format4)) break;
...
var import_vue = (0,_chunk_3RWA6CQF_js__WEBPACK_IMPORTED_MODULE_2__.__toESM)((0,_chunk_EJEZYNDH_js__WEBPACK_IMPORTED_MODULE_1__.require_vue)(), 1);
var VERSION2 = "9.14.5";
...
function createTextNode(key) {
    return (0, import_vue.createVNode)(import_vue.Text, null, key, 0);
}
...
function createComposer(options = {}, VueI18nLegacy) {
    ...
    const _ref = inBrowser ? import_vue.ref : import_vue.shallowRef;
    ...
    const _locale = _ref(// prettier-ignore
    __root && _inheritLocale ? __root.locale.value : isString(options.locale) ? options.locale : DEFAULT_LOCALE);
    const _fallbackLocale = _ref(// prettier-ignore
    ...
    const fallbackLocale = (0, import_vue.computed)({
        ...
        set: (val1)=>{
            _fallbackLocale.value = val1;
            _context.fallbackLocale = _fallbackLocale.value;
            updateFallbackLocale(_context, _locale.value, val1);
        }
    });
    ...
    function setPostTranslationHandler(handler1) {
        _postTranslation = handler1;
        _context.postTranslation = handler1;
    }
    function getMissingHandler() {
        return _missing;
    }
    function setMissingHandler(handler1) {
        if (handler1 !== null) {
            _runtimeMissing = defineCoreMissingHandler(handler1);
        }
        _missing = handler1;
    ...
    function t(...args) {
        return wrapWithDeps((context)=>Reflect.apply(translate, null, [
                context,
                ...args
            ]), ()=>parseTranslateArgs(...args), "translate", (root)=>Reflect.apply(root.t, root, [
                ...args
            ]), (key)=>key, (val1)=>isString(val1));
    }
    function rt(...args) {
        const [arg1, arg2, arg3] = args;
    ...
    function d(...args) {
        return wrapWithDeps((context)=>Reflect.apply(datetime, null, [
                context,
                ...args
            ]), ()=>parseDateTimeArgs(...args), "datetime format", (root)=>Reflect.apply(root.d, root, [
                ...args
            ]), ()=>MISSING_RESOLVE_VALUE, (val1)=>isString(val1));
    }
    function n(...args) {
        return wrapWithDeps((context)=>Reflect.apply(number, null, [
                context,
                ...args
            ]), ()=>parseNumberArgs(...args), "number format", (root)=>Reflect.apply(root.n, root, [
                ...args
            ]), ()=>MISSING_RESOLVE_VALUE, (val1)=>isString(val1));
    }
    function normalize(values) {
        return values.map((val1)=>isString(val1) || isNumber(val1) || isBoolean(val1) ? createTextNode(String(val1)) : val1);
    }
    const interpolate = (val1)=>val1;
    const processor = {
        normalize,
        interpolate,
        type: "vnode"
    ...
    function translateVNode(...args) {
        return wrapWithDeps((context)=>{
            ...
            try {
                ...
                ret = Reflect.apply(translate, null, [
                    _context2,
                    ...args
                ]);
            } finally{
        ...
        (root)=>root[TranslateVNodeSymbol](...args), (key)=>[
                createTextNode(key)
            ], (val1)=>isArray(val1));
    }
    function numberParts(...args) {
        return wrapWithDeps((context)=>Reflect.apply(number, null, [
                context,
                ...args
            ]), ()=>parseNumberArgs(...args), "number format", // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (root)=>root[NumberPartsSymbol](...args), NOOP_RETURN_ARRAY, (val1)=>isString(val1) || isArray(val1));
    }
    function datetimeParts(...args) {
        return wrapWithDeps((context)=>Reflect.apply(datetime, null, [
                context,
                ...args
            ]), ()=>parseDateTimeArgs(...args), "datetime format", // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (root)=>root[DatetimePartsSymbol](...args), NOOP_RETURN_ARRAY, (val1)=>isString(val1) || isArray(val1));
    }
    ...
    function te(key, locale2) {
        return wrapWithDeps(()=>{
            ...
            return !translateExistCompatible ? isMessageAST(resolved) || isMessageFunction(resolved) || isString(resolved) : resolved != null;
                ...
                key
            ], "translate exists", (root)=>{
            return Reflect.apply(root.te, root, [
                key,
                locale2
            ]);
        }, NOOP_RETURN_FALSE, (val1)=>isBoolean(val1));
    }
    ...
    composerID++;
    if (__root && inBrowser) {
        (0, import_vue.watch)(__root.locale, (val1)=>{
            if (_inheritLocale) {
                _locale.value = val1;
                _context.locale = val1;
                updateFallbackLocale(_context, _locale.value, _fallbackLocale.value);
            }
        });
        (0, import_vue.watch)(__root.fallbackLocale, (val1)=>{
            if (_inheritLocale) {
                _fallbackLocale.value = val1;
                _context.fallbackLocale = val1;
                updateFallbackLocale(_context, _locale.value, _fallbackLocale.value);
            }
        });
    }
...
function createVueI18n(options = {}, VueI18nLegacy) {
    {
        ...
        const vueI18n = {
            ...
            rt (...args) {
                return Reflect.apply(composer.rt, composer, [
                    ...args
                ]);
            },
            // tc
            ...
            // d
            d (...args) {
                return Reflect.apply(composer.d, composer, [
                    ...args
                ]);
            },
            // getDateTimeFormat
            ...
            // n
            n (...args) {
                return Reflect.apply(composer.n, composer, [
                    ...args
                ]);
            },
            // getNumberFormat
...
var baseFormatProps = {
    ...
    scope: {
        ...
        validator: (val1)=>val1 === "parent" || val1 === "global",
        default: "parent"
    },
    i18n: {
        type: Object
    ...
    if (keys.length === 1 && keys[0] === "default") {
        ...
        return ret.reduce((slot, current)=>{
            return [
                ...slot,
                // prettier-ignore
                ...current.type === import_vue.Fragment ? current.children : [
                    current
                ]
            ];
        }, []);
...
function getFragmentableTag(tag) {
    return import_vue.Fragment;
}
var TranslationImpl = (0, import_vue.defineComponent)({
    ...
    props: assign({
        ...
        plural: {
            ...
            validator: (val1)=>isNumber(val1) || !isNaN(val1)
        }
    }, baseFormatProps),
    /* eslint-enable */ // eslint-disable-next-line @typescript-eslint/no-explicit-any
    setup (props, context) {
        ...
        return ()=>{
            ...
            return (0, import_vue.h)(tag, assignedAttrs, children);
        };
    }
});
    ...
    return ()=>{
        ...
        if (isString(props.format)) {
            ...
            overrides = Object.keys(props.format).reduce((options2, prop)=>{
                return slotKeys.includes(prop) ? assign(create(), options2, {
...
var NumberFormatImpl = (0, import_vue.defineComponent)({
...
var DatetimeFormatImpl = (0, import_vue.defineComponent)({
...
function vTDirective(i18n) {
    const _process = (binding)=>{
        ...
        return [
            Reflect.apply(composer.t, composer, [
    ...
    const register = (el, binding)=>{
        ...
        if (inBrowser && i18n.global === composer) {
            el.__i18nWatcher = (0, import_vue.watch)(composer.locale, ()=>{
...
function apply(app, i18n, ...options) {
    ...
    if (globalInstall) {
        [
            ...
            "I18nT"
        ].forEach((name)=>app.component(name, Translation));
        [
            NumberFormat.name,
            "I18nN"
        ].forEach((name)=>app.component(name, NumberFormat));
        [
            DatetimeFormat.name,
            "I18nD"
        ].forEach((name)=>app.component(name, DatetimeFormat));
    }
    {
...
function _enableDevTools() {
    _enableDevTools = _async_to_generator(function*(app, i18n) {
        return new Promise((resolve, reject)=>{
            try {
                (0,_chunk_L6GOBQTK_js__WEBPACK_IMPORTED_MODULE_0__.setupDevtoolsPlugin)({
                    ...
                    api.on.getInspectorState(function() {
...
function createI18n(options = {}, VueI18nLegacy) {
    ...
    const symbol = makeSymbol( true ? "vue-i18n" : 0);
    if (true) {
...
function getI18nInstance(instance) {
    {
        const i18n = (0, import_vue.inject)(!instance.isCE ? instance.appContext.app.__VUE_I18N_SYMBOL__ : I18nInjectionKey);
        if (!i18n) {
...
function useI18nForLegacy(instance, scope, root, options = {}) {
    ...
    const _composer = (0, import_vue.shallowRef)(null);
    ...
    const _locale = (0, import_vue.ref)(// prettier-ignore
    !isLocalScope || _inheritLocale ? root.locale.value : isString(options.locale) ? options.locale : DEFAULT_LOCALE);
    const _fallbackLocale = (0, import_vue.ref)(// prettier-ignore
    ...
    const _datetimeFormats = (0, import_vue.ref)(isPlainObject(options.datetimeFormats) ? options.datetimeFormats : {
        [_locale.value]: {}
    });
    const _numberFormats = (0, import_vue.ref)(isPlainObject(options.numberFormats) ? options.numberFormats : {
        [_locale.value]: {}
    });
    ...
    const locale = (0, import_vue.computed)({
        ...
        set: (val1)=>{
            if (_composer.value) {
                _composer.value.locale.value = val1;
            }
            _locale.value = val1;
        }
    });
    const fallbackLocale = (0, import_vue.computed)({
        ...
        set: (val1)=>{
            if (_composer.value) {
                _composer.value.fallbackLocale.value = val1;
            }
            _fallbackLocale.value = val1;
        }
    });
    ...
    function setPostTranslationHandler(handler1) {
        if (_composer.value) {
            _composer.value.setPostTranslationHandler(handler1);
        }
    }
    function getMissingHandler() {
    ...
    function setMissingHandler(handler1) {
        if (_composer.value) {
            _composer.value.setMissingHandler(handler1);
        }
    }
    ...
    function t(...args) {
        return _composer.value ? warpWithDeps(()=>Reflect.apply(_composer.value.t, null, [
                ...args
            ])) : warpWithDeps(()=>"");
    }
    function rt(...args) {
        return _composer.value ? Reflect.apply(_composer.value.rt, null, [
            ...args
        ]) : "";
    }
    function d(...args) {
        return _composer.value ? warpWithDeps(()=>Reflect.apply(_composer.value.d, null, [
                ...args
            ])) : warpWithDeps(()=>"");
    }
    function n(...args) {
        return _composer.value ? warpWithDeps(()=>Reflect.apply(_composer.value.n, null, [
                ...args
            ])) : warpWithDeps(()=>"");
    }
    function tm(key) {
...
function injectGlobalFields(app, composer) {
    ...
    globalExportProps.forEach((prop)=>{
        ...
        const wrap = (0, import_vue.isRef)(desc.value) ? {
            get () {
                return desc.value.value;
            },
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            set (val1) {
                desc.value.value = val1;
            }
        } : {
            get () {
